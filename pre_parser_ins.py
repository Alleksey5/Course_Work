...
directory = "/content/drive/MyDrive/Special_folder/Для студентов/Проект_инсульт"
        ...
        for filename1 in os.listdir(os.path.join(directory, filename)):
            if os.path.isfile(os.path.join(os.path.join(directory, filename), filename1)):
                if filename == "ColorStroop":
                    ...
                    df_res.to_csv('/content/drive/MyDrive/Special_folder/res_st/pr_ins/ColorStroop/' + filename1[:-4] + '.dat', sep='\t', index=False)
                    ...
                    df_res.to_csv('/content/drive/MyDrive/Special_folder/res_st/pr_ins/FlankerTask/' + filename1[:-4] + '.dat', sep='\t', index=False)
                    ...
                    df_res.to_csv('/content/drive/MyDrive/Special_folder/res_st/pr_ins/GoNoGo/' + filename1[:-4] + '.dat', sep='\t', index=False)
                    ...
                    df_res.to_csv('/content/drive/MyDrive/Special_folder/res_st/pr_ins/NumericalStroop/' + filename1[:-4] + '.dat', sep='\t', index=False)
                    ...
                    df_res.to_csv('/content/drive/MyDrive/Special_folder/res_st/pr_ins/N-back/' + filename1[:-4] + '.dat', sep='\t', index=False)
                    ...
                    dffin.to_csv('/content/drive/MyDrive/Special_folder/res_st/pr_ins/TaskSwitching/' + 'rep' + filename1[:-4] + '.dat', sep='\t', index=False)
                    ...
                    dffin.to_csv('/content/drive/MyDrive/Special_folder/res_st/pr_ins/TaskSwitching/' + 'switch' + filename1[:-4] + '.dat', sep='\t', index=False)
